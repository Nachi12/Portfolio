  ...
  return (
    <section id="about" className="py-16">
      ...
      <div className="grid gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8 space-y-5 font-sans text-sm leading-relaxed text-[#A1A1AA]">
          ...
          <ul className="space-y-2 border-l border-[#242424] pl-4 font-mono text-xs text-[#F5F5F5]">
        ...
        {/* Right Info Box */}
        <div className="lg:col-span-4 editorial-card rounded-xl p-6 font-mono text-xs space-y-4">

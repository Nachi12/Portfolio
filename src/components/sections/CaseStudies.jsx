  ...
  return (
    <ContinuousSectionWrapper id="projects" glowColor="emerald" stagger={true}>
      ...
      <div className="space-y-16">
        {/* Project 01: HireLog */}
        <motion.div variants={staggerItem} data-cursor="view">
          <Tilt3D maxTilt={4} scale={1.012}>
            <div className="editorial-card rounded-xl p-6 lg:p-8">
              <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="pt-3 border-t border-[#242424] flex flex-wrap items-center justify-between gap-3 font-mono text-xs translate-z-25">
                    ...
                    <Magnetic maxDisplacement={8}>
                      <motion.a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-[#F5F5F5] hover:text-[#22C55E] transition-colors inline-flex items-center gap-1"
                      >
                        GitHub Repository ↗
                      </motion.a>
                    </Magnetic>
                ...
                {/* Right Architectural Diagram Box with Scroll Parallax */}

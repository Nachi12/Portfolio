    ...
    <div>
      <div className="fixed top-0 left-0 h-screen w-20 bg-gray-900 flex flex-col items-center py-6 space-y-6 shadow-lg border-r border-gray-700">
        {[
          {
            id: "home",
            src: "https://img.icons8.com/?size=100&id=PmkXCJ6t2lBA&format=png&color=FFFFFF",
            title: "Home",
          },
          {
            id: "about",
            src: "https://img.icons8.com/?size=100&id=Pq3ux42zaZVT&format=png&color=FFFFFF",
            title: "About",
          },
          {
            id: "projects",
          ...
          {
            id: "contact",
            src: "https://img.icons8.com/?size=100&id=rsjakOsn77By&format=png&color=FFFFFF",
            title: "Contact",
          },
        ].map((icon) => (
          <img

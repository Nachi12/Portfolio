...
import { buttonHover, buttonTap, EASE_PREMIUM } from '../../utils/motion'
...
export const RecruiterBar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3 rounded-lg border border-[#242424] bg-[#0A0A0A]/95 p-2 shadow-2xl backdrop-blur-md">
        {/* Availability Badge */}
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-end font-mono text-xs">
          ...
          <Magnetic maxDisplacement={6}>
            <motion.a
              ...
              href={resumeUrl}
              download
              className="rounded bg-[#F5F5F5] px-3 py-1.5 text-[#050505] font-semibold hover:bg-white transition-colors inline-block"
            >
              PDF ⬇
            </motion.a>
          </Magnetic>
